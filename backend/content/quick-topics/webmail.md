...
**University webmail** is used for official communication and often for **recovering access** to other systems.

**Logging in:** Use the **official webmail entry point** linked from **Makerere** or **MyPortal** for your account type (student or staff). Prefer signing in through the university’s documented URL rather than search results.

**Forgot email password:** Use the provider’s **password recovery** (e.g. **Forgot password**) on the official sign-in page. Ensure your **recovery phone or alternate email** is up to date when the system allows it.
